...
public class LoginController {
    ...
    private void redirectToDashboard(String role) throws IOException {
        ...
        if (role.equalsIgnoreCase("Admin")) {
            fxmlFile = "/com/example/payrollmanagement/AdminDashboard.fxml";
        } else {
            fxmlFile = "/com/example/payrollmanagement/EmployeeDashboard.fxml";
        }
    ...
    private void goToRegister() {
        try {
            Parent root = FXMLLoader.load(getClass().getResource("/com/example/payrollmanagement/register.fxml"));
